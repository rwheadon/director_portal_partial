class UserProfilesController < ApplicationController
  ...
  def create
    ...
    if UserProfile.where("user_id = ? AND is_deleted = ?" , @user_profile.user_id , false ).count > 0
      @user_profile.errors.add(:base, "A user profile already exists for the email you have chosen. " )
      respond_to do |format|
